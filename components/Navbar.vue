...
<div class="navbar mb-5 mt-5">
    <div class="flex flex-row">
        ...
        <a class="basis-0 grow text-center" href="https://linkedin.com/in/joshua-cepeda"> linkedin </a>
        <a class="basis-0 grow text-center" href="/dl/joshua_cepeda_resume.pdf"> résumé </a>
    </div>
    <!-- 
    <div class="flex flex-row">
